...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Editar Generacion </h5>
    ...
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Editar Generacion {{ $generacion->nombre }}</h1>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.generaciones.update', $generacion->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                                ...
                                                value="{{ old('nombre', $generacion->nombre) }}"
                                            ...
                                            <select class="form-control @error('carrera_id') is-invalid @enderror"
                                                ...
                                                @foreach ($carreras as $carrera)
                                                    <option value="{{ $carrera->id }}"
                                                        {{ old('carrera_id', $generacion->carrera_id) == $carrera->id ? 'selected' : '' }}>
                                                        {{ $carrera->nombre }}
                                                    </option>
                                                @endforeach
                                            </select>
